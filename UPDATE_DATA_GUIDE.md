# 🚀 Quick Update: Replace Supabase Data
...
2. **Paste the SQL above**: Copy everything and paste it
3. **Click "Run"**: Execute the query
4. **Check Results**: You should see:
   - `total_ipos: 38` 
   - Top 10 IPOs with highest GMP

## **What This Does:**

- ✅ Clears all old sample data
- ✅ Inserts 38 real IPOs with actual GMP data
- ✅ Includes currently open and upcoming IPOs
- ✅ Shows verification at the end

## **After Running:**

Your Supabase database will have:
- **3 Open IPOs**: LG Electronics, Tata Capital, DSM Fresh Foods
- **35 Upcoming IPOs**: JSW Infrastructure, Yatra Online, etc.
- **Real GMP percentages**: 15.35%, 4.60%, 2.97%, etc.
- **Actual issue prices**: ₹100, ₹200, ₹101, etc.

**Then refresh your app at http://localhost:8000 to see the new data!** 🎉
